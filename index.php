...
<body>
  <?php include_once('./i18n_setup.php'); ?>
  <!-- header -->
      ...
      <div class="ui doubling stackable grid container main">
        <div class="sixteen wide column">
          ...
          <div class="ui very padded segment">
            ...
            <p><?=_("Bienvenue sur le portail des nouvelles technologies pour la langue bretonne. Ce site a été mis en place par l'") ?><a href="https://www.brezhoneg.bzh/" class="ui link" target="_blank"><?=_("Office public de la langue bretonne") ?></a> <?=_("afin de promouvoir les différents outils et ressources numériques disponibles pour le breton.") ?></p>
            <p>
              <?=_("Ces outils et ressources sont disponibles librement et gratuitement.
            ...
            <div class="ui cards">
              ...
              <a href="https://www.fr.brezhoneg.bzh/36-termofis.htm" class="ui card">
                <div class="content">
              ...
              <a href="https://www.fr.brezhoneg.bzh/40-kerofis.htm" class="ui card">
                <div class="content">
              ...
              <a href="http://meurgorf.brezhoneg.bzh/" class="ui card">
                <div class="content">
                  <em data-emoji="book" class="right floated small"></em>
                  <div class="header">Meurgorf</div>
                  <div class="meta">Dictionnaire historique</div>
                  <div class="description">
                    <p><?=_("Meurgorf est un dictionnaire entièrement en breton, qui présente une large palettes d'informations sur plus de 50 000 mots.") ?></p>
                    <p>Chaque définition est accompagnée d'exemples d'utilisation historiques datés et sourcés de la littérature bretonne.</p>
                  </div>
                </div>
                <div class="extra content">
                  <div class="ui right floated buttons">
            ...
            <div class="ui cards">
              ...
              <a class="ui card" href="/apertium/index.fra.html">
                <div class="content">
              ...
              <div class="ui card" href="/sintezenn/index.php">
