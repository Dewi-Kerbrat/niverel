    ...
    <div class="toc">
      <div class="ui vertical secondary big menu">
        ...
        <div class="ui left pointing dropdown item">
          ...
          <div class="menu">
            <a class="item" href="/fr/meurgorf/"><em data-emoji=":book:"></em>MeurGorf - Dictionnaire historique du breton</a>
          </div>
        </div>
        <div class="ui left pointing dropdown item">
          Bases de données
          ...
          <i class="ui dropdown icon"></i>
          <div class="menu">
            <a class="item" href="/fr/kerofis/"><em data-emoji=":map:"></em>KerOfis - Base de donnée toponymique</a>
        ...
        <div class="ui left pointing dropdown item">
          ...
          <i class="ui dropdown icon"></i>
          <div class="menu">
            <a href="/fr/corpus/text/" class="item"><i class="file alternate icon"></i>Corpus textuel</a>
            <a href="/fr/corpus/audio/" class="item"><i class="file audio icon"></i>Corpus audio</a>
          </div>
        </div>
        <div class="ui left pointing dropdown item">
          <i class="user icon"></i>
        ...
        <div class="ui left pointing dropdown item">
          ...
          <i class="ui dropdown icon"></i>
          <div class="menu">
            <a class="item" href="/fr/apertium/index.fra.html"><i class="language icon"></i>Apertium - Traducteur automatique</a>
          </div>
        </div>
        <div class="ui left pointing dropdown item">
          ...
          <i class="ui dropdown icon"></i>
          <div class="menu">
            <a class="item" href="/fr/sintezenn/"><i class="comment icon"></i>Sintezenn - Synthèse de la parole</a>
          </div>
        </div>
        <div class="ui left pointing dropdown item">
        ...
        <a class="item" href="/fr/strategie/">
          ...
          <div class="ui very padded segment">
            ...
            <div class="ui stackable three column grid">
              ...
              <div class="column">
                ...
                <a class="ui pink fluid card" href="#">
                  ...
                  <div class="extra content">
                    <button href="#" class="ui labeled icon fluid pink button">
                      <i class="external link icon"></i>
                      Accéder à la ressource
                    </button>
                  </div>
            ...
            <div class="column">
              <a class="ui pink fluid card" href="#">
                ...
                <div class="extra content">
                  <button href="https://opus.nlpl.eu/" class="ui labeled icon pink fluid button">
                    <i class="external link icon"></i>
                    Accéder à la ressource
                  </button>
                </div>
